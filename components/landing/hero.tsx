  ...
  return (
    <section className="relative overflow-hidden h-[65vh] sm:h-[70vh] bg-zinc-900 border-zinc-800 border rounded-3xl group shadow-2xl">
      <img
        ...
        alt="Aika Labs - Software de inteligencia artificial para Latinoamerica"
      ...
      <div className="flex flex-col sm:px-6 z-10 text-center h-full pr-4 pl-4 relative items-center justify-center">
        <div className="max-w-4xl space-y-8">
          ...
          <h1 className="sm:text-7xl lg:text-8xl leading-[0.95] text-balance text-5xl font-medium tracking-tighter pb-2">
            <span className="text-white drop-shadow-md">Software con</span>
          ...
          <p className="text-lg sm:text-xl font-normal text-zinc-300 tracking-tight max-w-2xl mx-auto leading-relaxed text-pretty drop-shadow-sm">
            Salud digital, WhatsApp Business y aplicaciones voice-first
            para escalar negocios en Latinoamerica.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-6">
            <a
              href="#productos"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-cyan-50 text-cyan-950 text-sm font-medium hover:bg-white transition shadow-[0_0_20px_rgba(34,211,238,0.3)] hover:shadow-[0_0_30px_rgba(34,211,238,0.5)]"
            >
              Ver Productos
            </a>
            <Link
